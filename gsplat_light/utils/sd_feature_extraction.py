...
def parse_args():
    ...
    parser.add_argument("--image_dir", "-i", type=str, default='sfm_output/mvs')
    parser.add_argument("--output", "-o", type=str, default='sfm_output/mvs/SD')
...
def main(args):
    ...
    print(args.image_dir, args.output)
